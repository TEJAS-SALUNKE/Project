            ...
            <div className="mb-3 text-center">
                ...
                <div className="row">
                    <div className="col-md-3"> 
                        <strong className="fs-3 form-label">Categories</strong>
                        {
                        ...
                        <div className="row">
                                    ...
                                    return(
                                        <div className="col-md-3 col-sm-6 col-xs-12 myCardElement">
                                            <div className="card">
                                                ...
                                                {
                                                    product.imageName &&
                                                    <img src={url_image + `/${product.imageName}`} alt="product" className="img-fluid productImage"/>
                                                }
                                                {
                                                    !product.imageName &&
                            ...
                            }
                            {
                                ...
                                <div>
                                    ...
                                    <h4 className="text-center"> No products in this category yet!</h4>
                                </div>
                            }  
                        </div>
                    </div>
