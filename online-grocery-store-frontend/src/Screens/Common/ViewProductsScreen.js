                                    ...
                                    <div className="card-body text-center">
                                        {
                                            ...
                                            <img src={url_image+`/${detail.product.imageName}`} alt="productimage" className="img-fluid productImage"/>
                                        ...
                                        <div className="card-text">
                                            <h5>{detail.product.price} &#8377; / {detail.stock.unit} </h5>
                                            <hr/>
                                            <div className="row">
                                                <div className="col-md-4 Block stockData">{detail.stock.quantity} {detail.stock.unit}</div>
